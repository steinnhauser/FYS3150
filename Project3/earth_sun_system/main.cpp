...
int main(int argc, char* argv[])
{
  ...
  double z0 = 0;
  double xv0 = 0;
  double yv0 = 2*M_PI*1.01; // One rotation per year + circular motion
  double zv0 = 0;
  ...
  verlet_method_calculate(x0, y0, z0, xv0, yv0, zv0, N, dt, x_pos2, y_pos2, z_pos2, kin_energy2, pot_energy2, 2.001);
