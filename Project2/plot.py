...
for i in range(4):
    ...
    with open("./data/project2_" + str(i) + ".txt","r") as infile:
        ...
        words = re.sub(":,[^\w]", " ",  line).split() # splits line into list of words that were seperated by : or , or character
        eigval = eval(words[1])
...
plt.title(r"Ground state wave function for different angular frequencies, $\omega_r$")
